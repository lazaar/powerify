...
export const addFileToTheme = shopify => {
    shopify.theme.list().then(themes => {
        themes.every(function (theme) {
            addFileToThemeEntry(shopify, theme);
        });
    });
...
function addFileToThemeEntry(shopify, theme) {

    shopify.asset.create(theme.id, {
