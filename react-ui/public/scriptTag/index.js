...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__features_salespop__ = __webpack_require__(3);
/**
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(self.settings.salespop && (self.settings.salespop.enableDesktop && !self.inMobile) || (self.settings.salespop.enableMobile && self.inMobile)){
                    __WEBPACK_IMPORTED_MODULE_2__features_salespop__["a" /* default */].init(self.isProductPage, self.settings.salespop);
                }
            },
            error: function(e) {
...
/* harmony default export */ __webpack_exports__["a"] = (salesPop);
